                ...
                <div className='container checkout__container'>
                    ...
                    <div className='checkout__content2'>
                        <form className="checkout__form">
                            ...
                            <div className='checkout__groups'>
                                <div className="checkout__group">
                                    ...
                                    <input className='checkout__input' type="text" id="street-address" name="street-address" required placeholder="House number and street name" />
                                </div>
                                <div className="checkout__group">
                        ...
                        <div className='checkout__order'>
                            ...
                            <button className='checkout__btn2'>Place Order</button>
                        </div>
                    </div>
                    <Like />
                    <GreenShop />
